...
class Docs extends React.Component {
    ...
    render() {
        ...
        return (
            <div className="article toc2 toc-left">

                <div id="header">
                    <h1><span className="image"><img src="./images/LogoASW.png" alt="arc42"></img></span> Radarin Es3a</h1>
...
The system can be accessed on android and iOS phones as well as in desktop environments.</p>
                            ...
                            <div className="sect2">
                                ...
                                <div className="imageblock">
                                    <div className="content">
                                        <img src="./images/images/01_ContextDiagram.png" alt="Context Context" />
                                    </div>
                                </div>
                                <table className="tableblock frame-all grid-all stretch">
                                    <colgroup>
                    ...
                    <div className="sect1">
                        ...
                        <div className="sectionbody">
                            ...
                            <div className="sect2">
                                ...
                                <div className="imageblock">
                                    <div className="content">
                                        <img src="./images/images/03_BusinessContextDiagram.png" alt="Business Context" />
                                    </div>
                                </div>
                                <table className="tableblock frame-all grid-all stretch">
                                    <colgroup>
...
<strong>*</strong></p>
                    ...
                    <div className="sect1">
                        ...
                        <div className="sectionbody">
                            ...
                            <div className="paragraph">
                                <p><span className="image"><img src="./images/images/05-BuildingBlockDiagram.png" alt="Building Block" /></span></p>
                            </div>
                            <div className="sect2">
...
Pod interface --&gt; User: Provides account</pre>
                                    </div>
                                </div>
                            </div>
                            <div className="sect2">
                                ...
                                <div className="listingblock">
                                    <div className="content">
                                    <img src="./images/06_Log in diagram.png" alt="Context Context" />
                                    </div>
                                </div>
...
User1Application -&gt; User1: Notifies confirmation</pre>
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
Application --&gt; User: Shows locations</pre>
                                    </div>
                                </div>
                                <div className="pgbraf"></div>
                            </div>
                    ...
                    <div className="sect1">
                        ...
                        <div className="sectionbody">
                            <div className="sidebarblock">
                                <div className="content">
                                    <div className="paragraph">
                                        <p><span className="image"><img src="./images/images/07-deploymentDiagram.png" alt="Infraestructure" /></span></p>
                                    </div>
                                    <div className="paragraph">
                    ...
                    <div className="sect1">
                        ...
                        <div className="sectionbody">
                            <div className="sect2">
                                ...
                                <div className="paragraph">
                                    <p><span className="image"><img src="./images/images/StarUML_DomainModel.png" alt="Domain model" /></span></p>
                                </div>
                                <div className="paragraph">
                                ...
                                <div className="paragraph">
                                    <p><span className="image"><img src="./images/images/08-Crosscutting-Concepts-Structure-EN.png" alt="Possible topics for crosscutting concepts" /></span></p>
                                </div>
                            </div>
                            <div className="sect2">
                        ...
                        <div className="sectionbody">
                            <div className="sect2">
                                ...
                                <div className="sidebarblock">
                                    <div className="content">
                                        <div className="paragraph">
                                            <p><span className="image"><img src="./images/images/10_QualityTree.png" alt="Quality Tree" /></span></p>
                                        </div>
                                    </div>
                                </div>
                            </div>
