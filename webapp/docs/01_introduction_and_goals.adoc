...
We are going to develop a mobile and web application for the localization of different users in the system.

The functionality that the application will provide:

. Registration in the system.

. Adding of other users.

. Localization of added users.
